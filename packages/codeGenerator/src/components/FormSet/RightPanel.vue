  ...
  <div class="right-board">
    ...
    <div class="field-box">
      <el-scrollbar class="right-scrollbar">
        ...
        >
          <el-form-item
            v-if="activeData.__config__ && activeData.__config__.changeTag"
            label="组件类型"
          >
            <el-select
          ...
          <!-- <el-form-item v-if="activeData.__vModel__!==undefined&&activeData.__config__.tag!=='div'" label="字段名">
          ...
          >
            <el-input
              ...
              placeholder="请输入默认值"
              :type="activeData.__config__.tag === 'div' ? 'textarea' : ''"
